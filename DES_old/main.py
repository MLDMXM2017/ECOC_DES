...
from Tools.Distance import fisher_measure
...
if __name__ == '__main__':
    ...
    file_names = ['balance', 'car', 'cleveland', 'dermatology', 'glass', 'iris', 'led7digit']  #我先不加isolet和letter了                                                                #总数据集       flore与zoo只剩下了一类
                                                        #UCI data
    matrix_types = ['OVA', 'OVO', 'DenseRand']
                                                        #ECOC algorithms
    base_cly_names = ['SVM', 'Logi']
                                                        #Base classifiers
