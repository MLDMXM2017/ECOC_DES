...
from CodeMatrix import Matrix_tool as MT
from CodeMatrix.Distance import *
from CodeMatrix.SFFS import sffs
from CodeMatrix import Greedy_Search
...
class ECOC_ONE(__BaseECOC):
    ...
    def __init__(self, distance_measure=euclidean_distance, base_estimator=MLPClassifier, iter_num=10, **param):
